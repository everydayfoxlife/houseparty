...
// Set language to english if browser language is english as well
/*var languageQuery = location.search.match(/language=([^&]*)/) || [];
var manualLanguage = languageQuery[1];
if (manualLanguage) {
	loader.setLanguage(manualLanguage);
...
// Commence downloading and execution of the "main" package.
